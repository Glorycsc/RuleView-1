...
public class VerticalRuleView extends View {
    ...
    public VerticalRuleView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public VerticalRuleView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void countMoveEnd() {
        ...
        mOffset = (mMinValue - mSelectorValue) * 10.0f / mPerValue * mLineSpaceWidth;//计算偏移量,是相对于最想的单位的偏移量
